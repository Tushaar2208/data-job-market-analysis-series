...
1. Download the [1_Salary_Dashboard.xlsx](1_Salary_Dashboard.xlsx) file.
2. Open the file in Microsoft Excel.
3. Use the **filters** (Job Title, Country, Schedule Type) to dynamically update the charts and see median salary differences.
